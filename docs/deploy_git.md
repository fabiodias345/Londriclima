...
git add -- apps/admin/css/layout.css apps/admin/css/whatsapp.css apps/admin/index.html apps/admin/js/modules/whatsapp.js apps/admin/assets/airmovebr-logo.jpeg docs/deploy_git.md
npm run frontend:test
git diff --cached --check
git diff --cached --stat
git status --short
git commit -m "fix: corrige atendimento WhatsApp e logo"
