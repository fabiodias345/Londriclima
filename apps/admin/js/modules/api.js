...
const agendaOsCategorySelect = document.querySelector("#agendaOsCategorySelect");
...
const recurrenceGeneratingCount = document.querySelector("#recurrenceGeneratingCount");
const recurrenceDueCount = document.querySelector("#recurrenceDueCount");
const recurrenceTechnicianCount = document.querySelector("#recurrenceTechnicianCount");
const recurrenceDoneCount = document.querySelector("#recurrenceDoneCount");
const recurrenceFilterButtons = document.querySelectorAll("[data-recurrence-filter]");
...
const equipmentCategorySelect = document.querySelector('#equipmentForm select[name="categoria"]');
...
let activeRecurrenceFilter = "";
const generatingRecurrencePlanIds = new Set();
