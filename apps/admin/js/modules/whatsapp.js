...
whatsappClientForm = function (conversa) { return whatsappClientFormBase(conversa).replace('<label>Cidade', '<label>E-mail<input name="email" type="email" autocomplete="email" placeholder="cliente@exemplo.com"></label><label>Cidade'); };
