...
async function loadWhatsappConversation(id) {
  ...
  renderWhatsappConversations(); requestAnimationFrame(() => { const thread = document.querySelector(".whatsapp-thread"); if (!thread) return; thread.scrollTop = previousThreadScrollTop === null ? thread.scrollHeight : previousThreadScrollTop; });
}
