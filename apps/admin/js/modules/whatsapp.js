...
const operationalFormBase = operationalForm;
operationalForm = function (conversa) { if (conversa.cliente && isWhatsappMaintenance(conversa)) return levantamentoForm(conversa); return operationalFormBase(conversa); };
...
async function loadWhatsappConversation(id) {
  if (id !== selectedWhatsappId) { whatsappSelectedScheduleDate = ""; whatsappScheduleDraft = { equipeId: "", tecnicoId: "", data: "", horario: "", proposalText: "", proposalSent: false, context: "os" }; whatsappScheduleOpen = false; whatsappScheduleVisibleMonth = localDate().slice(0, 7); whatsappScheduleMode = "calendar"; }
