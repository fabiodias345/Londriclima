...
test("admin compila o bundle concatenado antes do deploy", async () => {
  ...
  const [
    ...
    loadModule("apps/admin/js/modules/comercial.js"),
    loadModule("apps/admin/js/modules/access-layout.js"),
  ...
  const sourceByName = {
    ...
    comercialRoot: comercial.comercialRoot,
    accessLayoutRoot: accessLayout.accessLayoutRoot,
...
test("admin possui views funcionais para agenda clientes e relatorios", () => {
  ...
  assert.doesNotMatch(html, /id="scanEquipmentCodeButton"/);
...
test("admin detalhe da O.S. prepara historico execucao e evidencias", () => {
  ...
  assert.match(script, /function formatOsEquipmentLabel/);
